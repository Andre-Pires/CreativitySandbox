...
namespace Assets.Scripts.SelectionBox
{
    ...
    public class SelectionBox : MonoBehaviour
    {
        ...
        private void ValidateCanvas()
        {
            ...
            if (canvasScaler && canvasScaler.enabled &&
                (!Mathf.Approximately(canvasScaler.scaleFactor, 1f) ||
	 ...
	 */
        ...
        private void ResetBoxRect()
        {
            ...
            var image = boxRect.GetComponent<Image>();
            image.color = color;
            image.sprite = art;
        ...
        private void BeginSelection()
        {
            ...
            {
                behavioursToGetSelectionsFrom = FindObjectsOfType<MonoBehaviour>();
            }
            else
            {
            ...
            var selectableList = new List<IBoxSelectable>();

            foreach (var behaviour in behavioursToGetSelectionsFrom)
            {
                //If the behaviour implements the selectable interface, we add it to the selectable list
                var selectable = behaviour as IBoxSelectable;
                if (selectable != null)
                {
        ...
        private void DragSelection()
        {
            ...
            var difference = currentMousePosition - origin;
            ...
            foreach (var selectable in selectables)
            {
                ...
                selectable.preSelected =
                    RectTransformUtility.RectangleContainsScreenPoint(boxRect, screenPoint, null) &&
                    PointIsValidAgainstSelectionMask(screenPoint);
            }
        ...
        private void ApplySingleClickDeselection()
        {
            ...
            if (clickedAfterDrag != null && clickedBeforeDrag.selected &&
        ...
        private Vector2 GetScreenPointOfSelectable(IBoxSelectable selectable)
        {
            ...
            if (rectTransform)
            {
                ...
                var renderingCamera = GetScreenPointCamera(rectTransform);
