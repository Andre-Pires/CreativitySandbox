...
namespace Assets.Scripts.Primitives
{
    ...
    public class UILineRenderer : UIPrimitiveBase
    {
        ...
        private static readonly Vector2[] startUvs = {UV_TOP_LEFT, UV_BOTTOM_LEFT, UV_BOTTOM_CENTER, UV_TOP_CENTER};
        private static readonly Vector2[] middleUvs = {UV_TOP_CENTER, UV_BOTTOM_CENTER, UV_BOTTOM_CENTER, UV_TOP_CENTER};
        private static readonly Vector2[] endUvs = {UV_TOP_CENTER, UV_BOTTOM_CENTER, UV_BOTTOM_RIGHT, UV_TOP_RIGHT};
            ...
            for (var i = 0; i < segments.Count; i++)
            {
                if (!LineList && i < segments.Count - 1)
                {
                    ...
                    if (joinType == JoinType.Miter)
                    {
                        ...
                        if (miterDistance < vec1.magnitude/2 && miterDistance < vec2.magnitude/2 &&
                            angle > MIN_MITER_JOIN)
                        {
