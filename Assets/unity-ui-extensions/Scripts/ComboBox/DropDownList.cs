...
namespace Assets.Scripts.ComboBox
{
    ...
    public class DropDownList : MonoBehaviour
    {
		...
		*/
        ...
        private void RebuildPanel()
        {
            ...
            for (var i = 0; i < _panelItems.Count; i++)
            {
                if (i < Items.Count)
                {
                    ...
                    _panelItems[i].img.color = item.Image == null
                        ? new Color(1, 1, 1, 0)
                        : item.IsDisabled
                            ? new Color(1, 1, 1, .5f)
                            : Color.white;
                ...
                _panelItems[i].gameobject.SetActive(i < Items.Count);
                    // if we have more thanks in the panel than Items in the list hide them
            }
        }
        ...
        {
            var scrollbarWidth = Items.Count > ItemsToDisplay ? _scrollBarWidth : 0f;
            ...
            var dropdownHeight = _rectTransform.sizeDelta.y*Mathf.Min(_itemsToDisplay, Items.Count);
