...
namespace UnityStandardAssets.Cameras
{
    ...
    public class AutoCam : PivotBasedCameraRig
    {
        ...
        [SerializeField] private readonly bool m_FollowTilt = true;
            // Whether the rig will tilt (around X axis) with the target.

        [SerializeField] private readonly bool m_FollowVelocity = false;
        ...
        [SerializeField] private readonly float m_MoveSpeed = 3;
            // How fast the rig will move to keep up with target's position

        [SerializeField] private readonly float m_RollSpeed = 0.2f;
        ...
        [SerializeField] private readonly float m_SmoothTurnTime = 0.2f; // the smoothing for the camera's rotation

        [SerializeField] private readonly float m_SpinTurnLimit = 90;
        ...
        [SerializeField] private readonly float m_TargetVelocityLowerLimit = 4f;
        ...
        [SerializeField] private readonly float m_TurnSpeed = 1;
