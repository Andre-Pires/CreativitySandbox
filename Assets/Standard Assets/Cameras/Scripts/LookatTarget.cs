...
namespace UnityStandardAssets.Cameras
{
    public class LookatTarget : AbstractTargetFollower
    {
        ...
        [SerializeField] private readonly float m_FollowSpeed = 1;
        ...
        protected override void FollowTarget(float deltaTime)
        {
            ...
            var yAngle = Mathf.Atan2(localTarget.x, localTarget.z)*Mathf.Rad2Deg;
            ...
            var xAngle = Mathf.Atan2(localTarget.y, localTarget.z)*Mathf.Rad2Deg;
