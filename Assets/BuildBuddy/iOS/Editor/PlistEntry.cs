...
namespace BuildBuddy
{
    ...
    public class PlistEntry : ScriptableObject
    {
        ...
        {
            var entry = CreateInstance<PlistEntry>();
            entry.edited = true;
            return entry;
        }
        ...
        public static PlistEntry CreateInstance(XmlElement element, bool isArrayEntry = false)
        {
            ...
            switch (entry.entryType)
            {
                ...
                default:
                    ...
                    {
                        entry.valueEntries.Add(CreateInstance(child, entry.entryType == EntryTypes.ARRAY));
                    }
                    break;
            }
            return entry;
        ...
        public PlistEntry Clone()
        {
            ...
            foreach (var nestedEntry in valueEntries)
            {
        ...
        public void OnGUI()
        {
            ...
            {
                display = EditorGUILayout.Foldout(display,
                    "Plist Entry: " + (isArrayEntry ? "Array Entry " + arrayIndex : key));
            ...
            BBGuiHelper.BeginIndent();
            {
                ...
                switch (entryType)
                {
                    ...
                    default:
                        ...
                        {
                            valueEntries.Add(CreateInstance());
                        }
                        BBGuiHelper.EndIndent();
                        break;
                }
        ...
        private EntryTypes StringToEntryType(string type)
        {
            ...
            if (type.Equals(EntryTypes.BOOL.ToString()))
            {
                return EntryTypes.BOOL;
            }
            if (type.Equals(EntryTypes.DATA.ToString()))
            {
            ...
            if (type.Equals(EntryTypes.NUMBER.ToString()))
            {
                return EntryTypes.NUMBER;
            }
            if (type.Equals(EntryTypes.DICTIONARY.ToString()))
            {
