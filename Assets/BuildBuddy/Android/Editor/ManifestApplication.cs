...
namespace BuildBuddy
{
    ...
    public sealed class ManifestApplication : ManifestElement
    {
        ...
        {
            var application = CreateInstance<ManifestApplication>();
        ...
        protected override void UpdateAttributes(XmlDocument document)
        {
            ...
            UpdateOptionalAttribute(document, "requiredAccountType", !requiredAccountType.Equals(""),
                requiredAccountType);
            UpdateOptionalAttribute(document, "restrictedAccountType", !restrictedAccountType.Equals(""),
