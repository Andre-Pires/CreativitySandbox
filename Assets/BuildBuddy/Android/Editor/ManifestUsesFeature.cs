...
namespace BuildBuddy
{
    ...
    {
        private static readonly string[] featureArray =
        {
            "NONE", "hardware.audio.low_latency", "hardware.bluetooth",
            "hardware.bluetooth_le", "hardware.camera", "hardware.camera.autofocus", "hardware.camera.flash",
            "hardware.camera.front", "hardware.camera.any", "hardware.consumerir", "hardware.location",
            "hardware.location.network", "hardware.location.gps", "hardware.microphone", "hardware.nfc",
            "hardware.nfc.hce", "hardware.sensor.accelerometer", "hardware.sensor.light", "hardware.sensor.proximity",
            "hardware.sensor.stepcounter", "hardware.sensor.stepdetector", "hardware.screen.landscape",
            "hardware.screen.portrait", "hardware.telephony", "hardware.telephony.cdma", "hardware.telephony.gsm",
            "hardware.type.television", "hardware.faketouch", "hardware.faketouch.multitouch.distinct",
            "hardware.faketouch.multitouch.jazzhand", "hardware.touchscreen", "hardware.touchscreen.multitouch",
            "hardware.touchscreen.multitouch.distinct", "hardware.touchscreen.multitouch.jazzhand", "hardware.usb.host",
            "hardware.usb.accessory", "hardware.wifi", "hardware.wifi.direct", "software.app_widgets",
            "software.device_admin", "software.home_screen", "software.input_methods", "software.live_wallpaper",
            "software.sip", "software.sip.voip"
        };
        ...
        {
            var usesFeature = CreateInstance<ManifestUsesFeature>();
        ...
        public override void OnGUI()
        {
            ...
            feature =
                featureArray[EditorGUILayout.Popup("Feature: ", Array.IndexOf(featureArray, feature), featureArray)];
        ...
        private void Initialize()
        {
            ...
            {
                var featurePrefix = "android.";
                foreach (var standardFeature in featureArray)
                {
