...
using System.Linq;
using Assets.Procedural_Low_Poly_Cities.Scripts.clipper_library;
using Assets.Procedural_Low_Poly_Cities.Scripts.math3D;
using Assets.Procedural_Low_Poly_Cities.Scripts.mesh_operations;
using Assets.Procedural_Low_Poly_Cities.Scripts.triangulation;
using UnityEngine;

namespace Assets.Procedural_Low_Poly_Cities.Scripts
{
